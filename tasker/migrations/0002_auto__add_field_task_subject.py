...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.subject'
        db.add_column(u'tasker_task', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.subject'
        db.delete_column(u'tasker_task', 'subject_id')
    ...
    models = {
        ...
        u'tasker.task': {
            ...
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']", 'null': 'True', 'blank': 'True'}),
