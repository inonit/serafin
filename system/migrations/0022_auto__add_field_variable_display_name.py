...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.display_name'
        db.add_column(u'system_variable', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.display_name'
        db.delete_column(u'system_variable', 'display_name')
    ...
    models = {
        ...
        u'system.programuseraccess': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)'}),
        ...
        u'system.variable': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
