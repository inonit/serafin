...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.display_title'
        db.add_column(u'system_content', 'display_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


        # Changing field 'Variable.random_type'
        db.alter_column(u'system_variable', 'random_type', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
        # Adding field 'Session.display_title'
        db.add_column(u'system_session', 'display_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'Program.display_title'
        db.add_column(u'system_program', 'display_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.display_title'
        db.delete_column(u'system_content', 'display_title')


        # Changing field 'Variable.random_type'
        db.alter_column(u'system_variable', 'random_type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
        # Deleting field 'Session.display_title'
        db.delete_column(u'system_session', 'display_title')

        # Deleting field 'Program.display_title'
        db.delete_column(u'system_program', 'display_title')
    ...
    models = {
        ...
        u'system.programuseraccess': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 23, 0, 0)'}),
