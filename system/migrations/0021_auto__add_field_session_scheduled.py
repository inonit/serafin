...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.scheduled'
        db.add_column(u'system_session', 'scheduled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.scheduled'
        db.delete_column(u'system_session', 'scheduled')
    ...
    models = {
        ...
        u'system.programuseraccess': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)'}),
