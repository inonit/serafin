...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'system_variable', 'value', self.gf('django.db.models.fields.CharField')(max_length=32, default=''))
        db.alter_column(u'system_variable', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=32, default=''))

    def backwards(self, orm):

        db.alter_column(u'system_variable', 'value', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
        db.alter_column(u'system_variable', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        u'system.programuseraccess': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)'}),
